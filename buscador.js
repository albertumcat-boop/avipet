  ...
  registros.forEach(consulta => {
    ...
    card.innerHTML = `
      ...
      <div class="flex gap-2 mt-3 flex-wrap">
        ...
        <button type="button"
                onclick="window.abrirConsultaParaEditar('${consulta.id}')"
                class="text-[8px] px-3 py-1.5 rounded-lg font-black uppercase bg-amber-100 text-amber-700 hover:bg-amber-500 hover:text-white transition-all">
          ✏️ Editar
        </button>
        <button type="button"
